            ...
            <div class="tablebox">
              <table class="table table-hover" style="margin-top: 20px;border: 1px solid #ddd;font-size: 12px;width: 100%">
                ...
                <tr class='grayTr'>
                  ...
                  <td style="padding: 15px 0;text-indent: 9px" width="20%">描述</td>
                  <td style="padding: 15px 0;text-indent: 9px" width="15%">图片</td>
                  <td style="padding: 15px 0;text-indent: 9px" width="35%">链接</td>
                ...
                <tr v-for="(item,index) in alltable" class="table_td">
                  ...
                  <td class="sortEditimg">
                    <img :src="imgapis+item.FUrl" height="40px">
                  </td>
                  <td class="sortEdit" >{{item.FGetUrl}}</td>
                  <td class="sortEdit">
                    <span class="btnbox" style="margin-right: 10px" @click="todetail(item.FIndex)">编辑</span>
                    <!--<span class="btnbox" @click="delfn" style="color: red">删除</span>-->
                  </td>
                </tr>
                </tbody>
              </table>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      todetail(id){
        this.$router.push({path:'/banner_detail',query:{id:id}})
      },
      findfn(){},
      getdata(){
        let _this = this
