      ...
      <div class="content">
        <div class="listbox">
          <div class="listbox_title">
            广告详情<el-button size="small" class="return_list" @click="returnback()" >返回列表</el-button>
          </div>
          <div class="show_table">
             <!--展示-->
            <div class="detailcont">
              <div class="itembox">
                <div class="itemname iteminput">名称</div>
                <div class="itemval inputvalbox">
                  <el-input v-model="bannerobj.FDescription" placeholder="请输入广告名称"></el-input>
                </div>
              </div>
      ...
      subfn(){
        ...
        this.axios.post(this.apis+'/apix/Products/Products/UploadADV',data).then((res)=>{
          ...
          if(res.data.statuscode==200){
            ...
            _this.$router.push({path:'/adv_list'})
          }else {
